...
So while Linux is free and offers freedom, it is quite a daunting type of freedom.
...
I don't think AI is real. The technical term for what we have right now is machine learning. I don't think AI is moral, because machine learning works on trained data, and the current models use data that has been stolen.
