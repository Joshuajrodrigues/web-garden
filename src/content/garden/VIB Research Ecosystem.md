...
- **Publication Management:** I helped maintain the platforms researchers use to index and share their scientific breakthroughs with the world.
...
- **Performance & Upkeep:** I was constantly reviewing and upgrading the existing codebases. Web standards move fast, and I had to make sure we weren't falling behind.

- **[[UI Consistency]]**: I made sure we used standardized design patterns so that when a user moves from one module to another, it doesn't feel like they've suddenly entered a different dimension.

- **Accessibility:** I focused on making these complex scientific tools actually intuitive. Even if someone isn't a "tech person," they should still be able to use the app to get their research done.